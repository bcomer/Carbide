...
export class CalculationValueService
{
    ...
    public getApi5lGradeValues(){
        return [{grade: 'A25', gradeValue: 25000}, {grade: 'A30', gradeValue: 30000}];
    }
    public getApi5Values(){
        return [{nominalPipeSize: '1/4', 
           nominalOd: 0.540, 
           wallThickness: [{wallThicknessValue: 0.088},{wallThicknessValue: 0.119}]},
           {nominalPipeSize: '1/2', 
            nominalOd: 0.840, 
            wallThickness: [{wallThicknessValue: 0.147}, {wallThicknessValue: 0.188}, {wallThicknessValue: 0.294}]}
       ]
     }
    
    public getDesignFactorValues(){
    return [{designFactorDescription: 'Location 1', designFactorValue: 0.72}, 
    ...
    public getLongitudinalJointFactorValues(){
     return [{jointFactorDescription: 'API 5L Seamless', jointFactorValue: 1.00}, 
    ...
    return [{deratingFactorDescription: '250 or less', deratingFactorValue: 1.000},
